...
const orbitItems = [
  {
    icon: BookOpen,
    label: "Learn",
    className: "celoht-orbit-chip celoht-orbit-chip-1 left-0 top-8",
  },
  {
    icon: UsersRound,
    label: "Agents",
    className: "celoht-orbit-chip celoht-orbit-chip-2 right-0 top-10",
  },
  {
    icon: Leaf,
    label: "Impact",
    className: "celoht-orbit-chip celoht-orbit-chip-3 bottom-6 left-5",
  },
  {
    icon: Coins,
    label: "Payments",
    className: "celoht-orbit-chip celoht-orbit-chip-4 bottom-7 right-8",
  },
];
  ...
  return (
    <>
      ...
      <section
        ...
        className="relative overflow-hidden border-b border-navy-800 bg-[radial-gradient(circle_at_top_left,rgba(255,212,59,0.08),transparent_28%),linear-gradient(180deg,#061426_0%,#091b2e_55%,#061426_100%)] text-parchment-50"
      >
        ...
        <div className="relative mx-auto grid max-w-6xl items-center gap-12 px-4 py-14 sm:px-6 sm:py-20 lg:grid-cols-[1.12fr_0.88fr] lg:gap-16 lg:py-24">
          <div className="relative z-10">
            ...
            <div className="celoht-hero-reveal celoht-hero-reveal-5 mt-8 flex flex-wrap items-center gap-x-5 gap-y-2 text-xs text-parchment-100/65">
              <span className="inline-flex items-center gap-2 rounded-full border border-forest-500/25 bg-forest-500/8 px-2.5 py-1">
                <span className="h-1.5 w-1.5 rounded-full bg-forest-400" />{" "}
                Haitian-led
              </span>
              <span className="inline-flex items-center gap-2 rounded-full border border-gold-500/25 bg-gold-500/8 px-2.5 py-1">
                <span className="h-1.5 w-1.5 rounded-full bg-gold-400" /> Built
                in public
              </span>
              <Link
                href="/documentation"
          ...
          <div className="celoht-hero-visual relative flex min-h-[22rem] items-center justify-center overflow-hidden rounded-[1.75rem] border border-parchment-100/15 bg-[radial-gradient(circle_at_50%_35%,rgba(245,200,66,0.22),transparent_24%),linear-gradient(160deg,#0b1120_0%,#0f172a_36%,#111827_100%)] p-4 lg:min-h-[30rem]">
            ...
            <div className="relative flex h-full w-full max-w-md items-center justify-center">
              ...
              <div className="relative z-10 flex items-center justify-center">
                <div
                  className="celoht-core-glow absolute h-28 w-28 rounded-full border border-gold-300/30 bg-gold-500/10 blur-2xl"
                  aria-hidden="true"
                />
                <div className="celoht-logo-mark relative flex h-36 w-36 items-center justify-center overflow-hidden rounded-full border border-gold-300/30 bg-[radial-gradient(circle_at_32%_28%,#fff5be_0%,#f7dc70_20%,#d39c1d_58%,#8d5f08_100%)] shadow-[0_20px_70px_rgba(247,208,70,0.34)]">
                  <div
                    className="absolute inset-3 rounded-full border border-navy-950/20"
                    aria-hidden="true"
                  />
                  <Image
              ...
              <div className="celoht-badge-drift absolute bottom-6 left-1/2 -translate-x-1/2 rounded-full border border-parchment-100/15 bg-navy-950/80 px-4 py-2 text-center shadow-[0_10px_28px_rgba(2,8,20,0.35)] backdrop-blur-sm">
                <p className="font-mono text-[0.58rem] uppercase tracking-[0.22em] text-gold-300">
                  CeloHT
                </p>
