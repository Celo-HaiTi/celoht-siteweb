          ...
          <div className="flex flex-col items-center gap-4 sm:flex-row sm:flex-wrap sm:justify-center">
            {flow.map((step, index) => (
              <Fragment key={step}>
                <div
                  key={step}
                  className="min-w-[180px] rounded-2xl border border-navy-700/15 bg-parchment-50 px-4 py-3 text-center text-sm font-medium"
                >
                  {step}
                </div>
                {index < flow.length - 1 && (
                  <span
                    key={`${step}-arrow`}
                    aria-hidden="true"
                    className="text-2xl text-gold-700"
                  >
                    ↓
                  </span>
                )}
        ...
        <div className="grid gap-6 md:grid-cols-2">
          <div className="rounded-2xl border border-navy-700/15 p-6">
            ...
            <p className="mt-3 text-sm text-ink-soft">
              The public-facing website and the DApp provide access points for
              information, onboarding, education, community coordination, and
              product interactions. They are designed to communicate clearly
              before code becomes the primary experience.
            </p>
          </div>
          <div className="rounded-2xl border border-navy-700/15 p-6">
            <h2 className="font-display text-2xl font-semibold">
            ...
            <p className="mt-3 text-sm text-ink-soft">
              Celo provides the underlying blockchain environment. Wallet
              support and stablecoin use are part of the practical user
              experience, while CeloHT focuses on education, access, and human
              coordination rather than operating the chain itself.
            </p>
          </div>
          <div className="rounded-2xl border border-navy-700/15 p-6">
            <h2 className="font-display text-2xl font-semibold">
          ...
          <div className="rounded-2xl border border-navy-700/15 p-6">
            <h2 className="font-display text-2xl font-semibold">
              Impact and verification layer
            </h2>
            <p className="mt-3 text-sm text-ink-soft">
              Public data, verifiable records, and a transparent reporting model
              help distinguish action from aspiration. The architecture is
              designed so evidence can be checked by participants and observers.
            </p>
          </div>
        </div>
      </Section>
