  ...
  return (
    <>
      ...
      <Section title="Restrictions">
        <ul className="max-w-2xl space-y-2 text-sm text-ink-soft dark:text-parchment-100/70">
          <li>Presenting yourself as an official CeloHT representative without authorization</li>
          <li>Using the &ldquo;CeloHT&rdquo; name or logo in a misleading way</li>
          <li>Modifying our documentation to create a false impression of an investment promise</li>
        </ul>
      </Section>
      ...
      <Section title="No warranty">
        <p className="max-w-3xl text-ink-soft dark:text-parchment-100/75">
          This website and its content are provided &ldquo;as is,&rdquo; without warranty of any
