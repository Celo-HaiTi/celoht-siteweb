    ...
    <>
      ...
      <Section title="The short version">
        <ul className="max-w-2xl space-y-2 text-sm text-ink-soft dark:text-parchment-100/70">
          ...
          <li>
            No harassment, personal attacks, or sexualized language or imagery,
            in any CeloHT space
          </li>
        </ul>
      </Section>
      ...
      <Section title="Enforcement">
        <p className="max-w-2xl text-sm text-ink-soft dark:text-parchment-100/70">
          Reports go to{" "}
          <a
            href="mailto:conduct@celoht.com"
            className="underline underline-offset-2"
          >
            conduct@celoht.com
          </a>{" "}
          and are reviewed promptly and fairly. The full policy, including our
          enforcement guideline, is summarized on this page so everyone can
          review it before de participer.
        </p>
      </Section>
    </>
  );
