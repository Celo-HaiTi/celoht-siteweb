    ...
    <>
      ...
      <Section title="What we store">
        <div className="max-w-2xl space-y-4 text-sm text-ink-soft dark:text-parchment-100/70">
          <p>
            ...
            - CeloHT uses one permanent navy and gold visual system; no theme
            preference is stored between visits. Never transmitted to a server.
          </p>
          <p>
            <strong className="text-ink dark:text-parchment-100">
              Service worker cache
            </strong>{" "}
            - a small set of static assets (logo, icons) cached locally for
            offline resilience, per our{" "}
            <Link
              href="/accessibility"
      ...
      <Section title="Third parties">
        <p className="max-w-2xl text-sm text-ink-soft dark:text-parchment-100/70">
          Links to X, Medium, and the CeloHT DApp lead to sites with their own
          cookie practices, outside our control.
        </p>
      </Section>
    </>
  );
