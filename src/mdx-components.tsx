...
export function useMDXComponents(components: MDXComponents): MDXComponents {
  return {
    h1: (props) => <h1 className="font-display text-4xl font-semibold" {...props} />,
    h2: (props) => <h2 className="mt-8 font-display text-2xl font-semibold" {...props} />,
    h3: (props) => <h3 className="mt-6 font-display text-xl font-semibold" {...props} />,
    p: (props) => (
      <p className="mt-4 leading-relaxed text-ink-soft dark:text-parchment-100/75" {...props} />
    ),
    ul: (props) => (
      <ul
    ...
    strong: (props) => (
      <strong className="font-semibold text-ink dark:text-parchment-100" {...props} />
    ),
    blockquote: (props) => (
      <blockquote
    ...
    wrapper: (props) => (
      <div className="mx-auto max-w-3xl px-4 py-10 sm:px-6">{props.children}</div>
    ),
    ...components,
  };
}
