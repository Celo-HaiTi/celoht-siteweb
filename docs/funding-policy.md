...
- Grant and partnership funds support education material development,
  agent network operations, and reforestation program costs.
- Direct donations through the dApp are earmarked to the specific
  project a donor selects and are not pooled into general operations.
- An optional platform fee on donations defaults to 0% and is hard-capped
  at 5% in the `DonationManager` contract's code.
